    ...
    <div>
      <nav className='relative flex items-center justify-between bg-black bg-opacity-50 backdrop-blur-lg rounded-full mx-10 px-6 py-3 h-20 mt-5'>
        <div className='flex items-center'>
          <img src="img/logo.png" alt="Logo ku" height={60} width={60} className="brightness-95"/>
      ...
      <div>
      <main className='ms-[7rem] mt-[3rem] mr-[4rem] m-[3rem] mx-4'></main>
      <div className='flex items-center text-center'></div>
      <h1 className='text-[#fff] text-4xl font-bold px-20 '>Pembelajaran gitar adalah perjalanan pribadi yang penuh dengan tantangan dan pencapaian. Setiap chord yang Anda pelajari dan setiap lagu yang Anda kuasai membawa Anda lebih dekat kepada impian Anda menjadi seorang musisi yang mahir.</h1>
