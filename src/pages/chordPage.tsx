...
export default function ChordPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl text-white font-bold mt-[1rem] mx-4">Kekasih Bayangan</h1>
      <button className='absolute bg-white/20 hover:bg-blue-700 text-white font-bold px-[2rem] w-[10rem] ms-[40rem] rounded-bl-lg rounded mt-[1rem] m-[19rem]' onClick={handleAutoScroll}>
        <button className=''>Auto Scroll</button>
       
      </button>
      <div ref={scrollRef} style={{ overflowY: 'scroll', maxHeight: '30rem' }} className='px-rem]'>
        ...
        <div className='col-span-2 h-[34rem] bg-black backdrop-blur-lg rounded bg-black/60  '>
         ...
         <input type="text" placeholder='cari' className='bg-black/90 mt-3 w-[4rem] px-4 m-1 '/>
          <div className='text-[#436850] text-bold] m-10'>
